 ...
 */
final class Version20200822114209 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE movie CHANGE year year LONGTEXT DEFAULT NULL, CHANGE rating rating INT NOT NULL, CHANGE synopsis synopsis LONGTEXT NOT NULL');
    }
